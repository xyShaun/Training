...
public class TankMovement : MonoBehaviour
{
    ...
    private void UpdateOnSwitch()
    {
        ...
        {
            m_MovementInputValue = npadState.analogStickL.fx;
            m_TurnInputValue = -npadState.analogStickL.fy;
        }
        else if (npadStyle == NpadStyle.JoyRight)
        {
            m_MovementInputValue = -npadState.analogStickR.fx;
            m_TurnInputValue = npadState.analogStickR.fy;
        }
